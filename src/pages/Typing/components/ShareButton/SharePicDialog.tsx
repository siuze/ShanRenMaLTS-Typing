        ...
        <div ref={imageRef} className=" box-content w-85 bg-white p-4">
          ...
          >
            <div className=" w-full ">
              ...
              <div className="ml-5 mt-2 self-start text-xs text-gray-600">{`第 ${currentChapter + 1} 章 ${
                currentDictInfo.chapterName ? currentDictInfo.chapterName[currentChapter] : ''
              }`}</div>
            </div>
            <div className="mb-3 ml-5 mt-auto">
              <div className="text-xs">siuze.github.io/ShanRenMaLTS</div>
              <div className="mt-1 text-xs font-normal text-gray-400">山人码LTS · 悟道</div>
            </div>
